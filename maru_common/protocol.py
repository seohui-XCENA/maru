...
@dataclass
class PinKVRequest:
    """PIN_KV (0x16) - Pin a KV entry.

    Increments the entry's pin_count to protect it from eviction.
    Returns failure if the key does not exist.
    """
...
class BatchPinKVRequest:
    """BATCH_PIN_KV (0x25) - Batch pin KV entries."""
